...
ALTER TABLE `#__jlike_annotations` CHANGE `type` `type` varchar(100) NOT NULL DEFAULT '' COMMENT 'Can be comment, notes,private comment,collaborator comment, reviewer commentE.g collaborator, reviewer';
...
ALTER TABLE `#__jlike_todos` CHANGE `type` `type` varchar(100) NOT NULL DEFAULT '' COMMENT 'Type of the todo (self, reco, assign)';
...
ALTER TABLE `#__jlike_types` CHANGE `type` `type` varchar(150) NOT NULL DEFAULT '';
