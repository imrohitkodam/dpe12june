...
CREATE TABLE IF NOT EXISTS `#__logman_impressions` (
  ...
  KEY `idx_name-package` (`name`,`package`),
...
CREATE TABLE IF NOT EXISTS `#__logman_synchronization` (
  ...
  CONSTRAINT `#__logman_synchronization_ibfk_1` FOREIGN KEY (`uuid`) REFERENCES `#__logman_activities` (`uuid`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__logman_activities_impressions` (
  ...
  CONSTRAINT `#__logman_activities_impressions_ibfk_1` FOREIGN KEY (`logman_activity_id`) REFERENCES `#__logman_activities` (`logman_activity_id`) ON DELETE CASCADE,
  CONSTRAINT `#__logman_activities_impressions_ibfk_2` FOREIGN KEY (`logman_impression_id`) REFERENCES `#__logman_impressions` (`logman_impression_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
