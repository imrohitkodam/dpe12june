	...
	*/
	public function getInput()
	{
		...
		$showCalculation = (int) $this->getAttribute("show_calculation", 1);
		...
		{ 		
			...
			<script>
				jQuery(document).ready(function(){
						...
						calculateNumeriFieldData(<?php echo $calculationJsonField;?>,<?php echo $this->getAttribute("colorcombination");?>,<?php echo json_encode($fieldName);?>,<?php echo $this->id;?>,'<?php echo $defaultText;?>', <?php echo $showCalculation; ?>);
					});
		...
		elseif ($formName[0] == 'subform')
			{?>
				...
				<script>
					jQuery(document).ready(function(){
							// function call to  do calculation 
							calculateNumeriFieldDataSubform(<?php echo $this->getAttribute("colorcombination");?>,<?php echo json_encode($fieldName);?>,<?php echo $calculationJsonField;?>,'<?php echo $calculationFieldName;?>','<?php echo $defaultText;?>', <?php echo $showCalculation; ?>);
						});
					jQuery(document).on('change', 'select',function(event) {
						calculationOnchangeSubform(event, <?php echo $this->getAttribute("colorcombination");?>,<?php echo json_encode($fieldName);?>,<?php echo $calculationJsonField;?>,'<?php echo $calculationFieldName;?>','<?php echo $defaultText;?>', <?php echo $showCalculation; ?>);
					});
